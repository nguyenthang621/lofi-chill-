    ...
    songs:[
        {
            ...
            name:"chill1",
            type:"chill",
            path:"./assets/mainMusic/chill1.mp3"
        },
        {
            id :1,
            name:"chill3",
            type:"chill",
            path:"./assets/mainMusic/chill3.mp3"
        },
        {
            id :2,
            name:"jazz1",
            type:"jazzy",
            path:"./assets/mainMusic/jazz1.mp3"
        },
        {
            id :3,
            name:"jazz2",
            type:"jazzy",
            path:"./assets/mainMusic/jazz2.mp3"
        },
        {
            id :4,
            name:"sleepy1",
            type:"sleepy",
            path:"./assets/mainMusic/sleepy1.mp3"
        },
        {
            id :5,
            name:"sleepy2",
            type:"sleepy",
            path:"./assets/mainMusic/sleepy2.mp3"
        },
        {
            id :6,
            name:"sleepy3",
            type:"sleepy",
            path:"./assets/mainMusic/sleepy3.mp3"
        },
        {
            id :7,
            name:"sleepy4",
            type:"sleepy",
            path:"./assets/mainMusic/sleepy4.mp3"
        },
        {
            id :8,
            name:"talkingSad",
...
// change volume bar:
        $$("input[type=range]").forEach(function(e,index){
...
// render effectSongs:
    renderEffectSongs: function() {
        var htmls=this.effectSongs.map((item,index)=>{
            ...
            <input class="volume slider" data="${index}"" type="range" value="0" step="1" min="0" max="100">
